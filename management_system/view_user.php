...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><?php echo $title='Kullanıcı' ?></h1>
          </div><!-- /.col -->
...
<?php
if(isset($_GET['id'])){
	$type_arr = array('',"Yönetici","Yetkili","Çalışan");
...
<div class="container-fluid">
	<div class="card card-widget widget-user shadow">
      ...
      <div class="widget-user-image">
      	...
      	<?php else: ?>
        <img class="img-circle elevation-2" src="assets/uploads/<?php echo $avatar ?>" alt="Kullanıcı Resmi"  style="width: 90px;height:90px;object-fit: cover">
      	<?php endif ?>
      </div>
